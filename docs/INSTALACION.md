...
4. Espera unos segundos: NovaFolder se instala y se abre solo. No hay que elegir nada.

Al terminar verás:

- El **widget** de NovaFolder en la esquina superior izquierda del Escritorio (puedes moverlo arrastrando su barra superior).
- El ícono **morado** de NovaFolder en la bandeja del sistema, junto al reloj. Si no lo ves, está en la flecha **^**.
...
| Renombrar, mover o quitar | Clic derecho sobre la carpeta o el elemento |
| Dejar el Escritorio limpio | Ícono de la bandeja → **Quitar del Escritorio al agregar** |
...
Para comprobarlo a mano: ícono de la bandeja → **Buscar actualizaciones**.
...
- Ícono de la bandeja → **Carpeta de datos y registros**. Dentro de `logs` está el registro del día; adjúntalo si reportas un problema.

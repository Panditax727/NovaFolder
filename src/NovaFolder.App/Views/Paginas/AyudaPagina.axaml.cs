...
namespace NovaFolder.Views.Paginas
{
    ...
    public partial class AyudaPagina : UserControl
    {
        ...
        private static readonly (string Pregunta, string Respuesta)[] ListaPreguntas =
        {
            ...
            ("¿Cómo lo desinstalo?",
             "Ajustes → «Desinstalar NovaFolder», o desde Configuración de Windows → Aplicaciones. Si lo instalaste con el Setup, tus accesos directos vuelven solos al Escritorio. Si vino de la Microsoft Store, quedan en Documentos\\NovaFolder\\Accesos guardados para que no se pierdan.")
        };
